...
ui.page_opts(title="Canadian Weather: Live Data Example", fillable=True,)
...
with ui.sidebar(open="open"):
    ...
    ui.h2("🇨🇦 Canada Explorer", class_="text-center")
    ui.p(
        "A demonstration of real-time temperature readings in the Great North.",
        class_="text-center",
    )
    icon_svg('mountain-sun')
    ui.hr()

    @render_widget
    def small_map(width="100%", height="100px"):
        return Map(center=(64.7675, -102.8467), zoom=4,)
...
with ui.card(full_screen=True):
    ui.card_header("🌡️ Most Recent Readings")
